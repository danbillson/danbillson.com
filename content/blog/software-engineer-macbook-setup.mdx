...
Then I installed [oh-my-zsh](https://ohmyz.sh/) to enhance the terminal experience. I use the [git plugin](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/git) and aliases like `pn` for pnpm:

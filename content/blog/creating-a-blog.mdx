...
Now it’s time to write your own blog post, since this is my first post I won’t be able to give too much advice on how to write a blog post any time soon but I can recommend going and watching [Ali Abdaal’s video](https://youtu.be/vyVpRiqOvt4?feature=shared) on how he went about starting a blog and the lessons he has learned from doing so.

...
professional:
  - name: SoPost
    year: 2021 - Present
    body: I'm currently working at a very exciting company that is solving some interesting problems where I am able to have an impact in many different areas of our extensive lifecycle to get product samples into the hands of consumers. We are creating performant, flexible, and accessible apps using Elixir/Phoenix and NextJS.
  - name: Climb
    year: 2020 - 2021
